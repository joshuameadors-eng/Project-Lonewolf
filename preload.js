...
contextBridge.exposeInMainWorld('api', {
  ...
  mountIso:          (params) => ipcRenderer.invoke('iso:mount', params),
  dismountIso:       (params) => ipcRenderer.invoke('iso:dismount', params),
  isoStatus:         (params) => ipcRenderer.invoke('iso:status', params),
